...
const App: React.FC = () => {
  ...
  if (!settings.isAuthenticated) {
    return (
        <div className="w-full h-full md:h-[850px] md:max-w-[420px] md:rounded-[3rem] bg-white dark:bg-gray-900 shadow-2xl flex flex-col overflow-hidden relative border-[8px] border-gray-900 dark:border-gray-800 mx-auto">
  ...
  // --- MAIN APP VIEW ---
  return (
    <div className="w-full h-full md:h-[850px] md:max-w-[420px] md:rounded-[3rem] bg-gray-50 dark:bg-gray-950 flex flex-col shadow-2xl relative overflow-hidden text-sm font-sans border-[8px] border-gray-900 dark:border-gray-800 mx-auto">
      
      {/* CONTENT AREA */}
      {/* Removed global overflow-y-auto to let individual views handle their own scrolling */}
      <main className="flex-1 w-full relative overflow-hidden h-full">
        ...
        {view === 'bookmarks' && (
            <div className="animate-fade-in h-full flex flex-col relative bg-gray-50 dark:bg-gray-900">
                {/* Header */}
                <div className="bg-white dark:bg-gray-900 p-6 sticky top-0 z-30 shadow-sm border-b border-gray-100 dark:border-gray-800 flex justify-between items-end shrink-0">
                    <div>
                ...
                <div className="flex-1 overflow-y-auto custom-scrollbar p-5 pb-24 flex flex-col gap-6">
                    {/* Inline Productivity Tabs */}
                    <div className="flex p-1.5 bg-gray-200 dark:bg-gray-800 rounded-2xl sticky top-0 z-20 overflow-x-auto no-scrollbar shrink-0">
